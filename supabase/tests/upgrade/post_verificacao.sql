...
reset role;
select t.eq('classes regulares 2026: 1 versão oficial PUBLICADA (a 2026.2), 6 classes publicadas, 149 requisitos nela; a 2026.1 fica arquivada', (select count(*) from public.curriculum_versions where origem = 'oficial' and status = 'publicado') * 1000
