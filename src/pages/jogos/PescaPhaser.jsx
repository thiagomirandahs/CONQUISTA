...
export class PescaScene extends Phaser.Scene {
  ...
  create() {
    ...
    ;[46, 150, 262, 330].forEach((x, i) => this.add.text(x, 534, '🌿', { fontSize: '20px' }).setOrigin(0.5, 1).setAlpha(0.9).setAngle(i % 2 ? 8 : -8))
  ...
  atualizarHud() { this.pontosTxt.setText('🐟 ' + this.pontos) }
  ...
  lancar() {
    ...
    try { this.bolhas?.explode(6, this.anzol.x, SUPERFICIE) } catch { /* ok */ } // splash na entrada
  }
